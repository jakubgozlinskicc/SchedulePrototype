...
describe("BaseEventModal", () => {
  ...
  it("should call onChange when description textarea changes", () => {
    render(<BaseEventModal {...mockProps} />);
  ...
  it("should call onChange when start date input changes", () => {
    render(<BaseEventModal {...mockProps} />);
  ...
  it("should call onChange when end date input changes", () => {
    render(<BaseEventModal {...mockProps} />);
  ...
  it("should render children in modal-actions", () => {
    render(<BaseEventModal {...mockProps} />);
  ...
  it("should render with empty event data", () => {
